...
out = cv2.VideoWriter("output2.avi",cv2.VideoWriter_fourcc(*"MJPG"), 30,(1920,1080))
...
PATH_TO_CKPT ='/home/shiva/Downloads/frozen_inference_graph.pb'

# Path to label map file
PATH_TO_LABELS =os.path.join('/home/shiva/Downloads', 'labelmap.pbtxt')
...
while(video.isOpened()):
    ...
    if frame is None:
        print("Successfully ended check output")
        break
